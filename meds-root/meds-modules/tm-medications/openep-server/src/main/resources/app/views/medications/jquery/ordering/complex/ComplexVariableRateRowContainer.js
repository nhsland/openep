Class.define('app.views.medications.ordering.ComplexVariableRateRowContainer', 'tm.jquery.Container', {
  ...
  _buildGui: function()
  {
    var self = this;
    var rate =
        this.getTimedDoseElement() && this.getTimedDoseElement().doseElement &&
        tm.jquery.Utils.isNumeric(this.getTimedDoseElement().doseElement.rate) ?
    ...
    this._infusionRatePane = new app.views.medications.ordering.InfusionRatePane({
      ...
      allowZeroRate: this.isContinuousInfusion(),
  ...
  {
    var endString =
        date ? app.views.medications.MedicationTimingUtils.hourMinuteToString(date.getHours(), date.getMinutes()) : "";
    ...
    else
    {
      if (date)
      {
        var calculatedEndString =
            app.views.medications.MedicationTimingUtils.hourMinuteToString(date.getHours(), date.getMinutes());
