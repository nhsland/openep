Class.define('app.views.medications.ordering.VariableDoseDataEntryContainer', 'app.views.common.containers.AppDataEntryContainer', {
  ...
  _buildGui: function()
  {
    ...
    container.add(app.views.medications.MedicationUtils.crateLabel('TextLabel', this.view.getDictionary('dosing.interval')));
    container.add(this.dosingFrequencyPane);
    container.add(new tm.jquery.Spacer({type: 'vertical', size: 7}));
    container.add(app.views.medications.MedicationUtils.crateLabel('TextLabel', this.view.getDictionary('dose')));
  ...
  _addField: function(doseTime, numerator, denominator, enabled, frequencyType)
  {
    ...
    var dosePane = new app.views.medications.ordering.dosing.DoseContainer({
    ...
    var row = new tm.jquery.Container({
      cls: "dose-row",
      testAttribute: 'dose-row-container',
  ...
  _setDosageCalculationUnits: function()
  {
    if (!tm.jquery.Utils.isEmpty(this.medicationData))
    {
      ...
      var dosageCalculationUnits = app.views.medications.MedicationUtils.getDosageCalculationUnitOptions(
          this.view,
          doseUnit,
          this.getReferenceData().getHeight());
      var selectedId = null;
