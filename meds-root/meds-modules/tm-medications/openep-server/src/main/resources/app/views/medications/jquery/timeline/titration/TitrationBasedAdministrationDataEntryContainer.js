Class.define('app.views.medications.timeline.titration.TitrationBasedAdministrationDataEntryContainer', 'app.views.common.containers.AppDataEntryContainer', {
  ...
  _buildGUI: function()
  {
    ...
    titrationData.getTherapies().forEach(function findAdministrationTherapy(titrationTherapy)
    {
      ...
      {
        var doseHistoryRowContainer = this._addDoseHistoryRowContainerForTherapy(titrationTherapy, false, titrationType);
    ...
    {
      var doseHistoryRowAdministrationContainer = this._addDoseHistoryRowContainerForTherapy(
          therapyForAdministration,
          true,
          titrationType);
   ...
   * @param {String} titrationType (app.views.medications.TherapyEnums.therapyTitrationTypeEnum)
   * @private
   */
  _addDoseHistoryRowContainerForTherapy: function(titrationTherapy, isPrimary, titrationType)
  {
    var view = this.getView();
    ...
    var therapyRow = new app.views.medications.timeline.titration.TherapyDoseHistoryRowContainer({
      ...
      tickInterval: app.views.medications.MedicationTimingUtils.getTitrationTickIntervalByType(titrationType),
      flex: tm.jquery.flexbox.item.Flex.create(0, 0, "auto")
    });
