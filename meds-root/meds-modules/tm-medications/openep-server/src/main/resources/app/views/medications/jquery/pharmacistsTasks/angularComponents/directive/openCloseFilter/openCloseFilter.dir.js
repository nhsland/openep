var OpenCloseFilterDir = function() {
  return {
    ...
    controller: ['$scope', '$rootScope', '$timeout', 'tm.angularjs.common.tmcBridge.ViewProxy',
      function($scope, $rootScope, $timeout, viewProxy) {
      ...
      $rootScope.$on('documentClicked', function(event, target, escKey) {
        ...
        {
          $timeout(function openCloseFilterSafeScopeApply()
          {
            $scope.opened = false;
          });
        }
