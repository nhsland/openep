Class.define('app.views.medications.ordering.outpatient.EERContentExtensionContainer', 'app.views.medications.ordering.PrescriptionContentExtensionContainer', {
  ...
  _buildGui: function()
  {
    ...
    var magistralPreparationComponent = new app.views.medications.common.VerticallyTitledComponent({
    ...
    var typeOfCoverageComponent = new app.views.medications.common.VerticallyTitledComponent({
    ...
    var repetitionsComponent = new app.views.medications.common.VerticallyTitledComponent({
    ...
    var paymentOptionsComponent = new app.views.medications.common.VerticallyTitledComponent({
    ...
    var urgentCheckBoxComponent = new app.views.medications.common.VerticallyTitledComponent({
    ...
    var instructionComponent = new app.views.medications.common.VerticallyTitledComponent({
  ...
  getFormValidations: function()
  {
    ...
    validators.push(new tm.jquery.FormField({
      ...
      componentValueImplementationFn: function(component)
      {
        ...
        if (value)
        {
          return tm.jquery.Utils.isNumeric(value) && app.views.medications.MedicationUtils.isPositiveInteger(value) ?
              true :
              null;
        }
        else
  ...
  /**
   * @param {Object} config
   * @override Attaches additional properties to the constructor configuration.
   */
  attachTherapyConfig: function(config)
  {
    ...
    config.prescriptionLocalDetails = {
  ...
  _handleMagistralPreparation: function()
  {
    ...
    {
      if (this._medicationData.isAntibiotic())
      {
  ...
  _loadMedicationCbzCode: function()
  {
    ...
    view.sendGetRequest(url, params, function(data)
    {
