Class.define('app.views.medications.ordering.ProtocolOptionsContainer', 'app.views.common.containers.AppDataEntryContainer', {
  ...
  /** privates */
  _repeatWholeProtocolTimes: null,
  /** privates: components */
  ...
  _buildGui: function()
  {
    ...
    this._repeatProtocolTimesField = app.views.medications.MedicationUtils.createNumberField('n0', 45, "repeat-whole-protocol-field");
