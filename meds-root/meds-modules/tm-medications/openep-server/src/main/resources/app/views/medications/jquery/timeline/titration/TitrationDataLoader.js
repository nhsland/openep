Class.define('app.views.medications.timeline.titration.TitrationDataLoader', 'tm.jquery.Object', {
  ...
  _calculateIntervalFromEndTime: function(endTime)
  {
    ...
    startTime.setHours(
        startTime.getHours() - app.views.medications.MedicationTimingUtils.getTitrationIntervalHoursByType(this.getTitrationType()));
  ...
  _calculateIntervalFromStartTime: function(startTime)
  {
    ...
    endTime.setHours(
        endTime.getHours() + app.views.medications.MedicationTimingUtils.getTitrationIntervalHoursByType(this.getTitrationType()));
