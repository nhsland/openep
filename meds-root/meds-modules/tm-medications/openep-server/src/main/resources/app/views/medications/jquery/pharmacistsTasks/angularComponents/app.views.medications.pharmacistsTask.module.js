...
{
  'use strict';
  angular.module('tm.angularjs.gui.modules.pharmacistsTask', ['tm.angularjs', 'app.views.medications.angularjs.common',
    'ngResource', 'ngSanitize', 'data-table', 'ui.bootstrap.datepicker'])
