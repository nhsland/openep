...
Class.define('app.views.medications.common.dto.TherapyChangeReason', 'tm.jquery.Object', {
  ...
  /**
   * Correctly clones the given instance. Since {@link #changeReason} is a coded named identity, we don't need to clone
   * it as we never alter it's state.
   * @return {app.views.medications.common.dto.TherapyChangeReason}
   */
  clone: function()
  {
    return new app.views.medications.common.dto.TherapyChangeReason({
      changeReason: this.getReason(),
