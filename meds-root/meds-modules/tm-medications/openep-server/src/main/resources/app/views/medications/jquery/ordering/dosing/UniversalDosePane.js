Class.define('app.views.medications.ordering.dosing.UniversalDosePane', 'tm.jquery.Container', {
  ...
  {
    var self = this;
    this.numeratorField = app.views.medications.MedicationUtils.createNumberField('n2', 68, 'numerator-field');
    ...
    this.denominatorField = app.views.medications.MedicationUtils.createNumberField('n2', 68, 'denominator-field');
