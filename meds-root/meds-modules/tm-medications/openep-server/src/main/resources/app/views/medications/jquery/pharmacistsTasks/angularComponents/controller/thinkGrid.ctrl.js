                              ...
                              PharmacistGridType, SaveCareProviderIdsToContext, viewProxy, PharmacistsTaskService)
{
  ...
  /**
   * Executed when the bound view receives the 'update' command. The possible data payload can contain the desired
   * patient id's for which the data will be displayed. If no such payload is present, the application will assume
   * the care provider filter should be used.
   * @param {{patientIds: Array<String|number>}|*} [updateData=undefined]
   */
