Class.define('app.views.medications.timeline.administration.OxygenStartingDeviceDataEntryContainer', 'app.views.common.containers.AppDataEntryContainer', {
  ...
  _buildGui: function()
  {
    ...
    commentLabelContainer.add(app.views.medications.MedicationUtils.crateLabel(
        'TextLabel',
  ...
  {
    return this.getAdministration() && this.getAdministration().getAdministrationTime() ?
        this.getAdministration().getAdministrationTime() :
        CurrentTime.get();
  },
