Class.define('app.views.medications.pharmacists.TherapyContainerReviewViewToolbar', 'app.views.medications.common.therapy.TherapyContainerToolbar', {
...
Class.define('app.views.medications.pharmacists.TherapyContainerEditReviewContentToolbar', 'app.views.medications.common.therapy.TherapyContainerToolbar', {
  /* event handler callbacks */
...
Class.define('app.views.medications.pharmacists.TherapyContainerFlowViewReviewPaneToolbar', 'app.views.medications.common.therapy.TherapyContainerToolbar', {
