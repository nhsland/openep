...
public class MedicationOnDischargeReconciliationDto extends DataTransferObject implements JsonSerializable
{
  ...
  public MedicationOnDischargeReconciliationDto(
      final TherapyDto therapy,
      final String linkedAdmissionCompositionId,
      final String linkedOrderCompositionId,
      final TherapyChangeReasonDto changeReasonDto,
      final MedicationOnDischargeStatus status)
  {
