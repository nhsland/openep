...
public class OxygenTherapyDto extends TherapyDto
{
  ...
  private FlowRateMode flowRateMode;
  private OxygenStartingDevice startingDevice;
  private Double minTargetSaturation; // percent value between 0 and 1
  private Double maxTargetSaturation; //percent value 0 and 1
  ...
  public FlowRateMode getFlowRateMode()
  {
    return flowRateMode;
  }

  public void setFlowRateMode(final FlowRateMode flowRateMode)
  {
