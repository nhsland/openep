...
@SuppressWarnings({"TooBroadScope", "unused"})
@RunWith(SpringJUnit4ClassRunner.class)
public class MentalHealthAdditionalWarningsProviderTest
{
  @InjectMocks
  private final MentalHealthAdditionalWarningsProvider mentalHealthAdditionalWarningsProvider = new MentalHealthAdditionalWarningsProvider();

  @InjectMocks
  private final MentalHealthWarningsHandler mentalHealthWarningsHandler= new MentalHealthWarningsHandler();
  ...
  public void mock()
  {
    ...
    Mockito.when(medicationsBo.isMentalHealthMedication(anyLong())).thenReturn(true);
  }
