...
{
  @InjectMocks
  private final AdministrationTaskConverterImpl administrationTaskConverter = new AdministrationTaskConverterImpl();
  ...
  public void testConvertTasksToAdministrationPatientTasks()
  {
    ...
    assertEquals("500 mg", patientTasks.get(0).getPlannedDose());
    ...
    assertEquals("100 ml/h", patientTasks.get(1).getPlannedDose());
    ...
    assertEquals("120 mg", patientTasks.get(2).getPlannedDose());
  ...
  public void testConvertOxygenTaskWithStartingDeviceType()
  {
    ...
    final MedicalDeviceEnum startingDevice = MedicalDeviceEnum.HIGH_FLOW_TRACHEAL_CANNULA;
  ...
  public void testGetAdministrationStatusByTimeLate()
  {
    final AdministrationStatusEnum status =
        AdministrationStatusEnum.build(
